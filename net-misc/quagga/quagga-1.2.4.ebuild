...
inherit autotools flag-o-matic multilib pam readme.gentoo-r1 systemd tmpfiles 

DESCRIPTION="A free routing daemon replacing Zebra supporting RIP, OSPF and BGP"
HOMEPAGE="https://www.nongnu.org/quagga/"
SRC_URI="https://github.com/Quagga/${PN}/releases/download/${P}/${P}.tar.gz
	bgpclassless? ( https://mirrors.1-1-0-1.net/gentoo/net-misc/${PN}/${CLASSLESS_BGP_PATCH} )"
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-1.2.4-NETINET_IN_H.patch"
)
